        		...
        		<div role="tabpanel" class="tab-pane pestania" id="especificos">
                    <div class="container-fluid">
                        ...
                        <div class="col-md-6" style="border-left: 1px solid #D9D7D7;">
                            ...
                            <div class="row">
                                <button type="button" class="btn btn-info btn-cian navbar-right btn-siguiente" id="calprueba" href="#adicionales" aria-controls="adicionales" role="tab" data-toggle="tab">
                                    Siguiente <span class="glyphicon glyphicon-triangle-right"></span>
                                </button>
...
@section('script')
    ...
    <script>
        ...
        /*var clienteAct = $('#clienteActual');
        var idCliente=$('#id_cliente');

        idCliente.on('change', function(){
            var var1 = $('#id_cliente option:selected').text();
            var id1 = $('#id_cliente option:selected').val();
            clienteAct.val(var1);
        });

        var factual = $('#formato');
        var idform =$ ('#id_formats');

        idform.on('change', function(){
            var var1 = $('#id_formats option:selected').text();
            var id1 = $('#id_formats option:selected').val();
            factual.val(var1);
        });

        var prodactual = $('#producto');
        var idprod =$ ('#id_producto');

        idprod.on('change', function(){
            var var1 = $('#id_producto option:selected').text();
            var id1 = $('#id_producto option:selected').val();
            prodactual.val(var1);
        });
        ...
        idcara.on('change', function(){
            var var1 = $('#caras option:selected').text();
            var id1 = $('#caras option:selected').val();
            caractual.val(var1);
        }); */
    </script>
@endsection