	...
	<div class="modal-dialog" role="document">
		<div class="modal-content mod-yellow">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Agregar Colores</h4> 
			</div>
			<div class="modal-body">
				...
				{!!Form::open(['id'=>'form'])!!}
					...
					<div class="form-group">
                    	...
                    	{!!form::label('Color:')!!}
                   		{!!form::text('color',null,['id'=>'addcolor','class'=>'form-control','placeholder'=>'Escriba el color'])!!}
                {!!Form::close()!!}
                </div>
			</div>
			<div class="modal-footer">
				{!!link_to('#',$title ='Agregar',$attributes= ['id'=>'guardarColor','class'=>'btn btn-primary btn-cian'],$secure = null)!!}
			</div>		
		</div>
	</div>
</div>